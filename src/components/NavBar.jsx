...
const NavBar = () => {
    ...
    return (
        <header>
            <nav className="bg-cyan-900 bg-opacity-20 backdrop-blur-md rounded-3xl shadow-lg py-12 relative">
                ...
                <ul className={`items-center justify-center gap-4 px-16 ${isMenuOpen ? 'flex flex-col' : 'hidden'} lg:flex lg:flex-row`}>
